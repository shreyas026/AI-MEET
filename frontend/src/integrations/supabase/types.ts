  ...
  public: {
    Tables: {
      ...
      transcript_chunks: {
        ...
        Relationships: [
          {
            foreignKeyName: "transcript_chunks_meeting_id_fkey";
            columns: ["meeting_id"];
            isOneToOne: false;
            referencedRelation: "meetings";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "transcript_chunks_workspace_id_fkey";
            columns: ["workspace_id"];
            isOneToOne: false;
            referencedRelation: "workspaces";
            referencedColumns: ["id"];
    ...
    Functions: {
      ...
      search_transcripts: {
        Args: { _limit?: number; _q: string; _ws: string };
        Returns: {
          content: string;
          created_at: string;
          id: string;
    ...
    Enums: {
      ...
      meeting_status: "draft" | "uploading" | "transcribing" | "analyzing" | "ready" | "failed";
      risk_category:
        "delay" | "resource" | "technical" | "budget" | "dependency" | "client" | "other";
...
export const Constants = {
  public: {
    Enums: {
      app_role: ["admin", "manager", "member"],
      meeting_status: ["draft", "uploading", "transcribing", "analyzing", "ready", "failed"],
      risk_category: ["delay", "resource", "technical", "budget", "dependency", "client", "other"],
      risk_severity: ["low", "medium", "high"],
      task_priority: ["low", "medium", "high"],
      task_status: ["todo", "in_progress", "done"],
    },
